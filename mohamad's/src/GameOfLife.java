...
public class GameOfLife {
	...
	public void init() {
        ...
        //2nd shape 
        matrice[(size/2)-40][size/2]=Etat.Vivant;
		matrice[(size/2)-40][(size/2)+40]=Etat.Vivant;
		matrice[size/2][(size/2)-40]=Etat.Vivant;
		matrice[size/2][(size/2)+50]=Etat.Vivant;
		matrice[(size/2)+40][size/2]=Etat.Vivant;
		matrice[(size/2)+40][(size/2)+40]=Etat.Vivant;
		matrice[(size/2)-40][(size/2)+50]=Etat.Vivant;
		
		matricePast[(size/2)-40][size/2]=Etat.Vivant;
		matricePast[(size/2)-40][(size/2)+40]=Etat.Vivant;
		matricePast[size/2][(size/2)-40]=Etat.Vivant;
		matricePast[size/2][(size/2)+50]=Etat.Vivant;
		matricePast[(size/2)+40][size/2]=Etat.Vivant;
		matricePast[(size/2)+40][(size/2)+40]=Etat.Vivant;
		matricePast[(size/2)-40][(size/2)+50]=Etat.Vivant;
